...
const customerManagementRoutes = require('./routes/admin/customerManagementRoutes');
const employeeManagementRoutes = require('./routes/admin/employeeManagementRoutes');
