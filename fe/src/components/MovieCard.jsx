    ...
    return (
        <div className="bg-neutral-800 p-6 rounded-xl shadow-xl flex flex-col sm:flex-row items-center sm:items-start gap-6">
            ...
            <div className="flex-1 text-center sm:text-left">
                ...
                <h3 className="text-gray-400 text-base font-semibold mb-3">AVAILABLE SHOWTIMES</h3> {/* Changed to gray-400, text-base (smaller) */}
                ...
                <div className="flex flex-wrap gap-3 justify-center sm:justify-start">
                    {showtimes.length > 0 ? (
                        ...
                        <p className="text-gray-400 text-sm">No showtimes available for this movie today.</p>
                    )}
                </div>
            </div>
        </div>
