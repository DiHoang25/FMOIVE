    ...
    const fetchCombos = async () => {
      try {
        ...
        const fetchedCombos = activeCombos.map(combo => ({
          ...
          price: combo.price,
          image: combo.imageUrl || darkknight, // Use imageUrl from API, fallback to local asset
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          ...
          <div className="text-sm flex flex-col justify-between">
            ...
            <div className="mt-2">
              ...
              <p className="text-gray-200 text-2xl">Seat Price: {totalSeatPrice !== undefined ? totalSeatPrice.toFixed(2) : 'N/A'}$</p>
            </div>
          </div>
        </div>
        ...
        {loadingComboDetails ? (
          ...
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-4">
              <img
                src={selectedComboDetails.imageUrl || darkknight}
