    ...
    <SidebarLayout>
      <div className="p-6 text-white">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4">
          ...
          />
          <Link to="/admin/add-promotion" className="bg-red-600 hover:bg-red-700 text-white hover:text-white px-5 py-2.5 rounded-md text-center font-semibold shadow-sm transition-all duration-200 w-full sm:w-auto">
            + Add New Promotion
          </Link>
        </div>
