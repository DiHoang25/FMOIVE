          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <input
                id="account"
                type="text"
                className="w-full px-3 py-2 border border-gray-700 rounded-md bg-white text-black focus:outline-none focus:ring-1 focus:ring-red-700"
                {...register("account", {
            ...
            {/* Add this div container around your buttons */}
            <div className="flex space-x-4 mt-6">
              <button
                ...
                className="w-full py-2 px-4 bg-gray-600 hover:bg-gray-700 text-white font-semibold rounded-md transition-colors duration-200"
              >
                Cancel
              </button>
              ...
              <button
                ...
                className="w-full py-2 px-4 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-md disabled:opacity-50 transition-colors duration-200"
              >
