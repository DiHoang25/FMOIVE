...
const EditAdminProfile = () => {
  ...
  return (
    <SidebarLayout>
      <div className="text-white py-10 px-6 rounded-md min-h-screen bg-[#0f172a] flex justify-center items-start">
        <div className="max-w-3xl w-full bg-slate-800 p-8 rounded-xl shadow-lg">
          <h1 className="text-3xl font-bold mb-8 text-center text-red-500">Edit Profile</h1>
              ...
              <div key={name}>
                ...
                {editable && editStates[name] ? (
                  ...
                  <div className="flex justify-between items-center bg-white text-black font-medium px-3 py-2 rounded">
                    ...
                    {editable && (
                      <button onClick={() => toggleEdit(name)} className="text-gray-500 text-sm flex items-center gap-1">
                        <FaEdit /> Edit
                      </button>
                    )}
                  </div>
              ...
              <div>
                ...
                {editStates.date_of_birth ? (
                  ...
                  <div className="flex justify-between items-center bg-white text-black font-medium px-3 py-2 rounded">
                    ...
                    <button onClick={() => toggleEdit('date_of_birth')} className="text-gray-500 text-sm flex items-center gap-1">
                      <FaEdit /> Edit
                    </button>
                  </div>
                )}
              ...
              <div>
                ...
                {editStates.gender ? (
                  ...
                  <div className="flex justify-between items-center bg-white text-black font-medium px-3 py-2 rounded">
                    ...
                    <button onClick={() => toggleEdit('gender')} className="text-gray-500 text-sm flex items-center gap-1">
                      <FaEdit /> Edit
                    </button>
                  </div>
                )}
