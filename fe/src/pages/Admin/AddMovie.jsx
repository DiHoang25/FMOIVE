...
const AddMovie = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const selectedGenres = Object.keys(formData.genres).filter(g => formData.genres[g]);
    ...
    formDataToSend.append('show_times', JSON.stringify(formData.showTimes));
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <GernesPicker
                    ...
                    onChange={(updatedGenres) => setFormData({ ...formData, genres: updatedGenres })}
                  />
                </div>
