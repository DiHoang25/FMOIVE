                ...
                <div className="bg-slate-800 rounded-lg p-6 mt-6 max-w-6xl mx-auto shadow-xl">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mt-6 flex justify-end space-x-4">
                            ...
                            <button
                                type="submit"
                                className="bg-green-600 hover:bg-green-700 text-white font-medium py-3 px-8 rounded-lg shadow-md hover:shadow-lg transition duration-300 transform hover:-translate-y-1"
                            >
                                Submit Movie
                            </button>
                        </div>
