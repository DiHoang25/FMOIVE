...
const AddProduct = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.image) {
            message.error('Vui lòng chọn ảnh cho sản phẩm.');
            return;
        }
        ...
        const hide = message.loading('Adding product...', 0);

        try {
            const response = await axios.post('http://localhost:5000/api/product/new_product', form, {
                headers: {
