          ...
          <main className="flex-1 overflow-y-auto p-4">
            ...
            <div className="bg-gray-800 p-4 rounded-md mb-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Link to="/employee/add-combo" className="bg-green-500 hover:bg-green-600 text-white hover:text-white p-3 rounded-md text-center">
                  Add Combo Popcorn & Drinks
                </Link>
                <Link to="/employee/add-product" className="bg-orange-500 hover:bg-orange-600 text-white hover:text-white p-3 rounded-md text-center">
                  Add Products
                </Link>
              </div>
            </div>
