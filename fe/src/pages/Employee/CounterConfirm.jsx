            ...
            <div className="min-h-screen text-white py-10 px-4">
                <div className="max-w-5xl mx-auto bg-slate-800 rounded-2xl p-8 shadow-lg">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-8">
                                ...
                                <div>
                                    ...
                                    <div className="space-y-2 text-base">
                                        {combosDisplay.map(combo => (
                                            <div key={combo.id} className="flex justify-between bg-slate-700 px-4 py-2 rounded">
                            ...
                            {selectedProducts.length > 0 && (
                                <div className="mt-4">
                                    <h3 className="text-lg font-semibold text-red-500 mb-2">🥤 Additional Products</h3>
                                    <div className="space-y-2 text-base">
                                        {selectedProducts.map(product => (
                                            <div key={product._id} className="flex justify-between bg-slate-700 px-4 py-2 rounded">
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                ...
                                <div className="flex mt-1 gap-2">
                                    <input
                                        ...
                                        className="bg-slate-700 text-white px-4 py-2 rounded w-full text-sm focus:outline-none focus:ring-1 focus:ring-red-500"
                                    />
                                    <button
                            ...
                            <div>
                                ...
                                <div className="bg-slate-700 rounded-lg p-4 space-y-2 text-base">
                                    ...
                                    {selectedProducts.length > 0 && (
                                        <div className="flex justify-between">
                                            <span>Products</span>
                                            <span>{productsTotal.toLocaleString('vi-VN')} VND</span>
                                        </div>
                                    )}
                                ...
                                <p className="text-xs text-gray-300 mt-3 bg-slate-700 rounded px-3 py-2">
                    ...
                    <div className="flex justify-center gap-6 mt-10">
                        <button
                            onClick={() => navigate(-1)}
                            className="bg-gray-700 hover:bg-gray-600 text-white px-6 py-2 rounded text-base font-medium"
                        >
                            ← Back
                        </button>
                        <button
