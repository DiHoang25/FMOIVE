...
const AddCombo = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        formDataToSend.append('comboItems', JSON.stringify(comboItems));

        if (formData.fromDate) {
            formDataToSend.append('fromDate', formData.fromDate.toISOString());
        }
        if (formData.toDate) {
            formDataToSend.append('toDate', formData.toDate.toISOString());
        }
        if (formData.image) {
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            className="w-full p-1.5 rounded bg-slate-700 text-white"
                                            required
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-gray-300 mb-1">From Date (Optional)</label>
                                        <DatePicker
                                            name="fromDate"
                                    ...
                                    <div>
                                        <label className="block text-gray-300 mb-1">To Date (Optional)</label>
                                        <DatePicker
                                            name="toDate"
